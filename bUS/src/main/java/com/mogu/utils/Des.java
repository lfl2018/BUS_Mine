...
public class Des
{
   ...
   public static void main(String[] args)
   {
      try
      {
         String plaintext = "+中庆顶戴顶戴sd fsd f\n-/';\"";
         String ciphertext;
         String riqi = "20170301";
         ciphertext = Des.encryptDES(plaintext, riqi);
         System.out.println("密钥：" + riqi);
         System.out.println("密文：" + ciphertext);
         System.out.println("明文：" + plaintext);
         System.out.println("解密：" + Des.decryptDES(ciphertext, riqi));
      }
      catch (Exception e)
      {
