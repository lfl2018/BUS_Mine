...
import com.mogu.activity.TopicDetailActivity;
import com.mogu.adapter.TopicListAdapter;
import com.mogu.adapter.TxtNewsAdapter;
import com.mogu.app.Constant;
import com.mogu.app.MrLiUrl;
import com.mogu.app.Url;
import com.mogu.entity.topiclist.HuatiList;
import com.mogu.entity.topiclist.TopicList;
 ...
 *
 */
public class TxtNewsFragment extends Fragment implements OnClickListener {
	private ListView projectListView;
	private TxtNewsAdapter txtNewsAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (MLayout == null) {
			MLayout = inflater.inflate(R.layout.fragment_txtnews, null);
	...
	private void GetMydata() {
		...
		params.addBodyParameter("xwlmbh", "1001");
		x.http().post(params, new HttpCallBack() {
			...
			public void onError(Throwable arg0, boolean arg1) {
				...
				mLoadMoreListViewContainer.loadMoreError(errorCode,
						errorMessage);
				txtNewsAdapter.notifyDataSetChanged();
...
//				}
	...
	private void initPullToRefresh() {
		...
		txtNewsAdapter = new TxtNewsAdapter(getActivity(), list);
		projectListView.setAdapter(txtNewsAdapter);
		// 3.设置下拉刷新组件和事件监听
