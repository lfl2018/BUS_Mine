...
import com.mogu.adapter.VideoNewsAdapter;
...
public class VideoNewsFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (MLayout == null) {
			MLayout = inflater.inflate(R.layout.fragment_vedionews, null);
	...
	private void GetMydata() {
		...
		params.addBodyParameter("xwlmbh", "1003");
...
//				}
	...
	private void initPullToRefresh() {
		...
		videoNewsAdapter = new VideoNewsAdapter(getActivity(), list);
		projectListView.setAdapter(videoNewsAdapter);
		// 3.设置下拉刷新组件和事件监听
