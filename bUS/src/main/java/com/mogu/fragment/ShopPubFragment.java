...
public class ShopPubFragment extends Fragment implements OnClickListener {

	private WebView topicDetailWebView;
	private String topicId = "";
	private View mLayout;
	private String url = Url.BASE_URL + "BizReleaseUpload.action?mac000=";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (mLayout == null) {
			mLayout = inflater.inflate(R.layout.fragment_shop_pub, null);
			x.view().inject(this, mLayout);
			topicDetailWebView = (WebView) mLayout
					.findViewById(R.id.wv_topic_detail);
			pre = (TextView) mLayout.findViewById(R.id.tv_pre);
			save = (TextView) mLayout.findViewById(R.id.tv_save);
	...
	// }
	public void save(){
		String url = "javascript:businessReleaseUpload()";
		topicDetailWebView.loadUrl(url);
