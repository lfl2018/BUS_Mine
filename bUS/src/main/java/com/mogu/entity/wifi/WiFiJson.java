...
public class WiFiJson {
	...
	@Expose
	private List<FreeWifiList> wifiList1 = new ArrayList<FreeWifiList>();
	...
	/**
	 * 
	 * @return The wifiList1
	 */
	public List<FreeWifiList> getWifiList1() {
		return wifiList1;
	}
	 ...
	 *            The wifi_list1
	 */
	public void setWifiList1(List<FreeWifiList> wifiList1) {
		this.wifiList1 = wifiList1;
	}

	/**
	 * 
	 * @return The wifiList2
	 */
